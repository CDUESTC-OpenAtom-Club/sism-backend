...
VALUES
    ...
    (2001, 41001, NULL, '完成党委办公室年度重点工作分解与落实', 40.00, 1, '战略发展部下发至党委办公室', NOW(), NOW(), '定量', 0, false, 35, 36, 'DISTRIBUTED', 191),
    (2002, 41001, NULL, '形成党委统战领域专项推进台账', 30.00, 2, '战略发展部下发至党委办公室', NOW(), NOW(), '定性', 0, false, 35, 36, 'DISTRIBUTED', 191),
    (2039, 41001, NULL, '完成重点提案办理与反馈督办', 30.00, 3, '战略发展部下发至党委办公室', NOW(), NOW(), '定性', 0, false, 35, 36, 'DISTRIBUTED', 191),
    (2040, 41021, NULL, '落实校领导交办的临时性重要专项', 100.00, 1, '战略发展部下发至党委办公室', NOW(), NOW(), '定性', 0, false, 35, 36, 'DISTRIBUTED', 191),

    -- ========== 保卫处 (org_id=42, task_id=41002) ==========
    (2003, 41002, NULL, '完成保卫处年度安全巡检计划编制', 40.00, 1, '战略发展部拟下发至保卫处', NOW(), NOW(), '定量', 0, false, 35, 42, 'DISTRIBUTED', 215),
    (2004, 41002, NULL, '建立重点区域隐患整改闭环机制', 30.00, 2, '战略发展部拟下发至保卫处', NOW(), NOW(), '定性', 0, false, 35, 42, 'DISTRIBUTED', 215),
    (2043, 41002, NULL, '开展消防安全应急演练与培训', 30.00, 3, '战略发展部拟下发至保卫处', NOW(), NOW(), '定量', 0, false, 35, 42, 'DISTRIBUTED', 215),

    -- ========== 教务处 (org_id=44, task_id=41003 & 41022) ==========
    (2005, 41003, NULL, '推进教务处教学质量提升专项工作', 40.00, 1, '战略发展部拟下发至教务处', NOW(), NOW(), '定量', 0, false, 35, 44, 'DISTRIBUTED', 223),
    (2006, 41003, NULL, '完善课程建设与专业评估机制', 30.00, 2, '战略发展部拟下发至教务处', NOW(), NOW(), '定性', 0, false, 35, 44, 'DISTRIBUTED', 223),
    (2041, 41003, NULL, '开展通识教育课程体系改革', 30.00, 3, '战略发展部拟下发至教务处', NOW(), NOW(), '定性', 0, false, 35, 44, 'DISTRIBUTED', 223),
    (2042, 41022, NULL, '牵头组织全国大学生学科竞赛报名及指导', 100.00, 1, '战略发展部拟下发至教务处', NOW(), NOW(), '定量', 0, false, 35, 44, 'DISTRIBUTED', 223),
