...
\restrict 1mWOyAB05ZAKdUJ26qjnVQhiC1uSK7hztvfTKaTzAQ0VS735EQZCEbWctSSZGz3
...
--
-- Name: CAST (public.indicatorlevel AS character varying); Type: CAST; Schema: -; Owner: -
--

CREATE CAST (public.indicatorlevel AS character varying) WITH INOUT AS IMPLICIT;


--
-- Name: CAST (public.planlevel AS character varying); Type: CAST; Schema: -; Owner: -
--

CREATE CAST (public.planlevel AS character varying) WITH INOUT AS IMPLICIT;


--
-- Name: CAST (public.tasktype AS character varying); Type: CAST; Schema: -; Owner: -
--

CREATE CAST (public.tasktype AS character varying) WITH INOUT AS IMPLICIT;


--
-- Name: CAST (character varying AS public.indicatorlevel); Type: CAST; Schema: -; Owner: -
--

CREATE CAST (character varying AS public.indicatorlevel) WITH INOUT AS IMPLICIT;


--
-- Name: CAST (character varying AS public.planlevel); Type: CAST; Schema: -; Owner: -
--

CREATE CAST (character varying AS public.planlevel) WITH INOUT AS IMPLICIT;


--
-- Name: CAST (character varying AS public.tasktype); Type: CAST; Schema: -; Owner: -
--

CREATE CAST (character varying AS public.tasktype) WITH INOUT AS IMPLICIT;
...
--
-- Name: 2_warn_event; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public."2_warn_event" (
    id bigint CONSTRAINT warn_event_id_not_null NOT NULL,
    milestone_id bigint CONSTRAINT warn_event_milestone_id_not_null NOT NULL,
    indicator_id bigint CONSTRAINT warn_event_indicator_id_not_null NOT NULL,
    event_date date CONSTRAINT warn_event_event_date_not_null NOT NULL,
    metric_type character varying(16) CONSTRAINT warn_event_metric_type_not_null NOT NULL,
    target_progress integer,
    latest_progress integer,
    target_value numeric(10,2),
    latest_value numeric(10,2),
    gap_value numeric(12,2) CONSTRAINT warn_event_gap_value_not_null NOT NULL,
    level_id bigint CONSTRAINT warn_event_level_id_not_null NOT NULL,
    message text,
    is_ack boolean DEFAULT false CONSTRAINT warn_event_is_ack_not_null NOT NULL,
    ack_by bigint,
    ack_at timestamp with time zone,
    ack_note text,
    calc_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP CONSTRAINT warn_event_calc_at_not_null NOT NULL,
    CONSTRAINT warn_event_metric_type_check CHECK (((metric_type)::text = ANY ((ARRAY['PROGRESS'::character varying, 'VALUE'::character varying])::text[])))
);


--
-- Name: 2_warn_summary_daily; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public."2_warn_summary_daily" (
    id bigint CONSTRAINT warn_summary_daily_id_not_null NOT NULL,
    summary_date date CONSTRAINT warn_summary_daily_summary_date_not_null NOT NULL,
    org_type character varying(16) CONSTRAINT warn_summary_daily_org_type_not_null NOT NULL,
    org_id bigint CONSTRAINT warn_summary_daily_org_id_not_null NOT NULL,
    plan_id bigint,
    task_id bigint,
    level_id bigint CONSTRAINT warn_summary_daily_level_id_not_null NOT NULL,
    warn_count integer DEFAULT 0 CONSTRAINT warn_summary_daily_warn_count_not_null NOT NULL,
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP CONSTRAINT warn_summary_daily_created_at_not_null NOT NULL,
    CONSTRAINT warn_summary_daily_org_type_check CHECK (((org_type)::text = ANY ((ARRAY['FUNC_DEPT'::character varying, 'COLLEGE'::character varying])::text[]))),
    CONSTRAINT warn_summary_daily_warn_count_check CHECK ((warn_count >= 0))
);
...
CREATE TABLE public.adhoc_task (
    ...
    indicator_id bigint,
    CONSTRAINT adhoc_task_scope_type_check CHECK (((scope_type)::text = ANY ((ARRAY['ALL_ORGS'::character varying, 'BY_DEPT_ISSUED_INDICATORS'::character varying, 'CUSTOM'::character varying])::text[]))),
    CONSTRAINT adhoc_task_status_check CHECK (((status)::text = ANY ((ARRAY['DRAFT'::character varying, 'OPEN'::character varying, 'CLOSED'::character varying, 'ARCHIVED'::character varying])::text[])))
);
...
CREATE TABLE public.alert_event (
    ...
    CONSTRAINT alert_event_severity_check CHECK (((severity)::text = ANY ((ARRAY['INFO'::character varying, 'WARNING'::character varying, 'CRITICAL'::character varying])::text[]))),
    CONSTRAINT alert_event_status_check CHECK (((status)::text = ANY ((ARRAY['OPEN'::character varying, 'IN_PROGRESS'::character varying, 'RESOLVED'::character varying, 'CLOSED'::character varying])::text[])))
);
...
CREATE TABLE public.alert_rule (
    ...
    severity character varying(255) NOT NULL,
    cycle_id bigint NOT NULL,
    CONSTRAINT alert_rule_severity_check CHECK (((severity)::text = ANY ((ARRAY['INFO'::character varying, 'WARNING'::character varying, 'CRITICAL'::character varying])::text[])))
);
...
--
-- Name: approval_action_record; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.approval_action_record (
    id bigint NOT NULL,
    ...
    comment text,
    acted_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    target_user_id bigint,
    target_user_name character varying(100),
    ip_address character varying(50),
    before_status character varying(50),
    after_status character varying(50),
...
--
-- Name: approval_action_record_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.approval_action_record_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: approval_action_record_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.approval_action_record_id_seq OWNED BY public.approval_action_record.id;
...
CREATE TABLE public.approval_instances (
    ...
    level2_supervisor_id bigint,
    superior_dept_id bigint,
    pending_approvers_json text,
    approved_approvers_json text,
    approval_mode character varying(20) DEFAULT 'SEQUENTIAL'::character varying
);
...
CREATE TABLE public.approval_record (
    ...
    CONSTRAINT approval_record_action_check CHECK (((action)::text = ANY ((ARRAY['APPROVE'::character varying, 'REJECT'::character varying, 'RETURN'::character varying])::text[])))
);


--
-- Name: approval_record_approval_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.approval_record_approval_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: approval_record_approval_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.approval_record_approval_id_seq OWNED BY public.approval_record.approval_id;
...
CREATE TABLE public.approval_steps (
    ...
    step_description character varying(200),
...
--
-- Name: audit_action_log; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: audit_action_log_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: audit_action_log_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
CREATE TABLE public.audit_log (
    log_id bigint CONSTRAINT audit_log_log_id_not_null1 NOT NULL,
    action character varying(255) CONSTRAINT audit_log_action_not_null1 NOT NULL,
    after_json jsonb,
    before_json jsonb,
    changed_fields jsonb,
    created_at timestamp(6) without time zone CONSTRAINT audit_log_created_at_not_null1 NOT NULL,
    entity_id bigint CONSTRAINT audit_log_entity_id_not_null1 NOT NULL,
    entity_type character varying(255) CONSTRAINT audit_log_entity_type_not_null1 NOT NULL,
    reason text,
    actor_org_id bigint,
    actor_user_id bigint,
    CONSTRAINT audit_log_action_check CHECK (((action)::text = ANY ((ARRAY['CREATE'::character varying, 'UPDATE'::character varying, 'DELETE'::character varying, 'APPROVE'::character varying, 'ARCHIVE'::character varying, 'RESTORE'::character varying])::text[]))),
    CONSTRAINT audit_log_entity_type_check CHECK (((entity_type)::text = ANY ((ARRAY['ORG'::character varying, 'USER'::character varying, 'CYCLE'::character varying, 'TASK'::character varying, 'INDICATOR'::character varying, 'MILESTONE'::character varying, 'REPORT'::character varying, 'ADHOC_TASK'::character varying, 'ALERT'::character varying])::text[])))
);
...
--
-- Name: common_log; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: common_log_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: common_log_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
CREATE TABLE public.indicator (
    ...
    weight_percent numeric(38,2) DEFAULT 0 NOT NULL,
    ...
    is_deleted boolean DEFAULT false NOT NULL,
    indicator_id bigint CONSTRAINT indicator_indicator_id_not_null1 NOT NULL,
    ...
    distribution_status character varying(20) DEFAULT 'DISTRIBUTED'::character varying NOT NULL,
    CONSTRAINT indicator_progress_approval_status_check CHECK (((progress_approval_status)::text = ANY ((ARRAY['NONE'::character varying, 'DRAFT'::character varying, 'PENDING'::character varying, 'APPROVED'::character varying, 'REJECTED'::character varying])::text[])))
);
...
--
-- Name: indicator_indicator_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.indicator_indicator_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: indicator_indicator_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.indicator_indicator_id_seq OWNED BY public.indicator.indicator_id;
...
CREATE TABLE public.indicator_milestone (
    ...
    status character varying DEFAULT 'NOT_STARTED'::public.milestone_status CONSTRAINT milestone_status_not_null NOT NULL,
...
CREATE TABLE public.progress_report (
    ...
    CONSTRAINT progress_report_status_check CHECK (((status)::text = ANY ((ARRAY['DRAFT'::character varying, 'SUBMITTED'::character varying, 'RETURNED'::character varying, 'APPROVED'::character varying, 'REJECTED'::character varying])::text[])))
);
...
CREATE TABLE public.sys_task (
    task_id bigint CONSTRAINT strategic_task_task_id_not_null1 NOT NULL,
    created_at timestamp(6) without time zone CONSTRAINT strategic_task_created_at_not_null1 NOT NULL,
    updated_at timestamp(6) without time zone CONSTRAINT strategic_task_updated_at_not_null1 NOT NULL,
    remark text,
    sort_order integer CONSTRAINT strategic_task_sort_order_not_null1 NOT NULL,
    task_desc text,
    task_name character varying(200) CONSTRAINT strategic_task_task_name_not_null1 NOT NULL,
    task_type character varying(255) CONSTRAINT strategic_task_task_type_not_null1 NOT NULL,
    created_by_org_id bigint CONSTRAINT strategic_task_created_by_org_id_not_null NOT NULL,
    cycle_id bigint CONSTRAINT strategic_task_cycle_id_not_null1 NOT NULL,
    org_id bigint CONSTRAINT strategic_task_org_id_not_null NOT NULL,
    is_deleted boolean CONSTRAINT strategic_task_is_deleted_not_null1 NOT NULL,
    plan_id bigint CONSTRAINT strategic_task_plan_id_not_null NOT NULL,
    name character varying(255) CONSTRAINT strategic_task_name_not_null NOT NULL,
    type public.task_type CONSTRAINT strategic_task_type_not_null NOT NULL,
    "desc" character varying(255),
    CONSTRAINT strategic_task_task_type_check CHECK (((task_type)::text = ANY ((ARRAY['BASIC'::character varying, 'REGULAR'::character varying, 'KEY'::character varying, 'SPECIAL'::character varying, 'QUANTITATIVE'::character varying, 'DEVELOPMENT'::character varying])::text[])))
);
...
--
-- Name: sys_org_hierarchy; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.sys_org_hierarchy (
    id bigint NOT NULL,
...
--
-- Name: sys_org_hierarchy_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.sys_org_hierarchy_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: sys_org_hierarchy_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.sys_org_hierarchy_id_seq OWNED BY public.sys_org_hierarchy.id;
...
CREATE TABLE public.sys_user (
    id bigint CONSTRAINT sys_user_user_id_not_null NOT NULL,
    created_at timestamp(6) without time zone NOT NULL,
    updated_at timestamp(6) without time zone NOT NULL,
...
--
-- Name: sys_user_supervisor; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.sys_user_supervisor (
    user_id bigint NOT NULL,
...
--
-- Name: warn_event_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: warn_event_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.warn_event_id_seq OWNED BY public."2_warn_event".id;
...
--
-- Name: warn_rule; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: warn_rule_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: warn_rule_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: warn_summary_daily_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: warn_summary_daily_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.warn_summary_daily_id_seq OWNED BY public."2_warn_summary_daily".id;


--
-- Name: 2_warn_event id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."2_warn_event" ALTER COLUMN id SET DEFAULT nextval('public.warn_event_id_seq'::regclass);


--
-- Name: 2_warn_summary_daily id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."2_warn_summary_daily" ALTER COLUMN id SET DEFAULT nextval('public.warn_summary_daily_id_seq'::regclass);
...
--
-- Name: approval_action_record id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.approval_action_record ALTER COLUMN id SET DEFAULT nextval('public.approval_action_record_id_seq'::regclass);
...
--
-- Name: approval_record approval_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.approval_record ALTER COLUMN approval_id SET DEFAULT nextval('public.approval_record_approval_id_seq'::regclass);
...
--
-- Name: audit_action_log id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: common_log log_id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: indicator indicator_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.indicator ALTER COLUMN indicator_id SET DEFAULT nextval('public.indicator_indicator_id_seq'::regclass);
...
--
-- Name: sys_org_hierarchy id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sys_org_hierarchy ALTER COLUMN id SET DEFAULT nextval('public.sys_org_hierarchy_id_seq'::regclass);
...
--
-- Name: warn_rule id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: approval_action_record approval_action_record_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.approval_action_record
    ADD CONSTRAINT approval_action_record_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.approval_record
    ADD CONSTRAINT approval_record_pkey PRIMARY KEY (approval_id);
...
--
-- Name: audit_action_log audit_action_log_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: common_log audit_log_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_org_hierarchy sys_org_hierarchy_org_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sys_org_hierarchy
    ADD CONSTRAINT sys_org_hierarchy_org_id_key UNIQUE (org_id);


--
-- Name: sys_org_hierarchy sys_org_hierarchy_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sys_org_hierarchy
    ADD CONSTRAINT sys_org_hierarchy_pkey PRIMARY KEY (id);
...
--
-- Name: sys_user_supervisor sys_user_supervisor_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sys_user_supervisor
    ADD CONSTRAINT sys_user_supervisor_pkey PRIMARY KEY (user_id, level);
...
--
-- Name: audit_instance uq_audit_instance_biz; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: audit_step_def uq_audit_step_flow_code; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: audit_step_def uq_audit_step_flow_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: 2_warn_event uq_warn_event; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."2_warn_event"
    ADD CONSTRAINT uq_warn_event UNIQUE (milestone_id, event_date);


--
-- Name: 2_warn_summary_daily uq_warn_summary; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."2_warn_summary_daily"
    ADD CONSTRAINT uq_warn_summary UNIQUE (summary_date, org_type, org_id, plan_id, task_id, level_id);


--
-- Name: 2_warn_event warn_event_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."2_warn_event"
    ADD CONSTRAINT warn_event_pkey PRIMARY KEY (id);
...
--
-- Name: warn_rule warn_rule_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: 2_warn_summary_daily warn_summary_daily_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."2_warn_summary_daily"
    ADD CONSTRAINT warn_summary_daily_pkey PRIMARY KEY (id);
...
--
-- Name: idx_approval_action_acted_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_approval_action_acted_at ON public.approval_action_record USING btree (acted_at);


--
-- Name: idx_approval_action_action; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_approval_action_action ON public.approval_action_record USING btree (action);


--
-- Name: idx_approval_action_actor; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_approval_action_actor ON public.approval_action_record USING btree (actor_id);


--
-- Name: idx_approval_action_instance; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_approval_action_instance ON public.approval_action_record USING btree (instance_id);


--
-- Name: idx_approval_action_step; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_approval_action_step ON public.approval_action_record USING btree (step_id);


--
-- Name: idx_approval_action_target; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_approval_action_target ON public.approval_action_record USING btree (target_user_id);
...
--
-- Name: idx_approval_instances_submitter_dept; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_approval_instances_submitter_dept ON public.approval_instances USING btree (submitter_dept_id);


--
-- Name: idx_approval_steps_approver_org; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_approval_steps_approver_org ON public.approval_steps USING btree (approver_org_id);
...
--
-- Name: idx_approval_steps_step_order; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_approval_steps_step_order ON public.approval_steps USING btree (instance_id, step_order);
...
CREATE INDEX idx_audit_action ON public.common_log USING btree (action);


--
-- Name: idx_audit_action_log_instance; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_audit_action_log_instance ON public.audit_action_log USING btree (instance_id);


--
-- Name: idx_audit_action_log_time; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_audit_action_log_time ON public.audit_action_log USING btree (created_at);
...
CREATE INDEX idx_audit_actor ON public.common_log USING btree (actor_user_id);
...
CREATE INDEX idx_audit_created ON public.common_log USING btree (created_at);
...
CREATE INDEX idx_audit_entity ON public.common_log USING btree (entity_type, entity_id);


--
-- Name: idx_audit_flow_entity_type; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_audit_flow_entity_type ON public.audit_flow_def USING btree (entity_type);


--
-- Name: idx_audit_instance_biz; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_audit_instance_biz ON public.audit_instance USING btree (biz_type, biz_id);


--
-- Name: idx_audit_instance_flow_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_audit_instance_flow_id ON public.audit_instance USING btree (flow_id);
...
--
-- Name: idx_indicator_level; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_indicator_level ON public.indicator USING btree (level);


--
-- Name: idx_indicator_owner_dept; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_indicator_owner_dept ON public.indicator USING btree (owner_dept);
...
--
-- Name: idx_indicator_responsible_dept; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_indicator_responsible_dept ON public.indicator USING btree (responsible_dept);
...
--
-- Name: idx_indicator_year; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_indicator_year ON public.indicator USING btree (year);
...
--
-- Name: idx_org_hierarchy_org; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_org_hierarchy_org ON public.sys_org_hierarchy USING btree (org_id);
...
CREATE INDEX idx_org_hierarchy_parent ON public.sys_org_hierarchy USING btree (parent_org_id);
...
--
-- Name: idx_warn_event_date; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_warn_event_date ON public."2_warn_event" USING btree (event_date);


--
-- Name: idx_warn_event_level; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_warn_event_level ON public."2_warn_event" USING btree (level_id);


--
-- Name: idx_warn_rule_metric; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_warn_rule_metric ON public.warn_rule USING btree (metric_type);


--
-- Name: idx_warn_summary_date_org; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_warn_summary_date_org ON public."2_warn_summary_daily" USING btree (summary_date, org_type, org_id);
...
--
-- Name: approval_instances update_approval_mode_trigger; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_approval_mode_trigger BEFORE INSERT OR UPDATE ON public.approval_instances FOR EACH ROW EXECUTE FUNCTION public.update_approval_mode_to_parallel();


--
-- Name: approval_action_record approval_action_record_actor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.approval_action_record
    ADD CONSTRAINT approval_action_record_actor_id_fkey FOREIGN KEY (actor_id) REFERENCES public.sys_user(id);


--
-- Name: approval_action_record approval_action_record_instance_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.approval_action_record
    ADD CONSTRAINT approval_action_record_instance_id_fkey FOREIGN KEY (instance_id) REFERENCES public.approval_instances(id) ON DELETE CASCADE;


--
-- Name: approval_action_record approval_action_record_step_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.approval_action_record
    ADD CONSTRAINT approval_action_record_step_id_fkey FOREIGN KEY (step_id) REFERENCES public.approval_steps(id) ON DELETE SET NULL;


--
-- Name: approval_action_record approval_action_record_target_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.approval_action_record
    ADD CONSTRAINT approval_action_record_target_user_id_fkey FOREIGN KEY (target_user_id) REFERENCES public.sys_user(id);
...
--
-- Name: approval_record fk3mjsnaisct36xrhu1qu6uej0d; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.approval_record
    ADD CONSTRAINT fk3mjsnaisct36xrhu1qu6uej0d FOREIGN KEY (report_id) REFERENCES public.progress_report(report_id);
...
--
-- Name: approval_record fk62xydortyp5d7lni35v3s7c23; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.approval_record
    ADD CONSTRAINT fk62xydortyp5d7lni35v3s7c23 FOREIGN KEY (approver_id) REFERENCES public.sys_user(id);
...
--
-- Name: approval_steps fk_approval_steps_approver; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.approval_steps
    ADD CONSTRAINT fk_approval_steps_approver FOREIGN KEY (approver_id) REFERENCES public.sys_user(id) ON DELETE SET NULL;


--
-- Name: approval_steps fk_approval_steps_instance; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.approval_steps
    ADD CONSTRAINT fk_approval_steps_instance FOREIGN KEY (instance_id) REFERENCES public.approval_instances(id) ON DELETE CASCADE;
...
--
-- Name: indicator_milestone fknsg6vu52h1w3i9vjgtarsas0w; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.indicator_milestone
    ADD CONSTRAINT fknsg6vu52h1w3i9vjgtarsas0w FOREIGN KEY (inherited_from) REFERENCES public.indicator_milestone(id);
...
--
-- Name: sys_org_hierarchy sys_org_hierarchy_org_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sys_org_hierarchy
    ADD CONSTRAINT sys_org_hierarchy_org_id_fkey FOREIGN KEY (org_id) REFERENCES public.sys_org(id);


--
-- Name: sys_org_hierarchy sys_org_hierarchy_parent_org_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sys_org_hierarchy
    ADD CONSTRAINT sys_org_hierarchy_parent_org_id_fkey FOREIGN KEY (parent_org_id) REFERENCES public.sys_org(id);
...
\unrestrict 1mWOyAB05ZAKdUJ26qjnVQhiC1uSK7hztvfTKaTzAQ0VS735EQZCEbWctSSZGz3
