 ...
 *
 * IMPORTANT: Enum constant names must match database enum values exactly (lowercase)
 * because JPA @Enumerated(EnumType.STRING) uses the enum constant name(), not getValue()
 */
public enum OrgType {
    /**
     * 系统管理层
    ...
    public com.sism.enums.OrgType toSharedOrgType() {
        return com.sism.enums.OrgType.valueOf(name());
    }
