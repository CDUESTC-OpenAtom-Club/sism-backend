...
EOF
  ...
  run_plan_flow "PLAN_DISPATCH_STRATEGY" "流程一：战略发展部 Plan 下发审批" 4038 "zlb_admin" "/plans/4038/submit-dispatch"
  run_plan_flow "PLAN_DISPATCH_FUNCDEPT" "流程二：职能部门 Plan 下发审批" 403657 "dangban_report" "/plans/403657/submit-dispatch"
  run_plan_flow "PLAN_APPROVAL_FUNCDEPT" "流程三：职能部门 Plan 审批流程" 4044 "jiaowu_report" "/plans/4044/submit"
  run_plan_flow "PLAN_APPROVAL_COLLEGE" "流程四：二级学院 Plan 审批流程" 404457 "jisuanji_report" "/plans/404457/submit"
